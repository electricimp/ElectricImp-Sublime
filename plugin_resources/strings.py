...
STR_NO_DEVICES_AVAILABLE  = "There are no Imp devices registered in the system. Please register a device and try again"
...
STR_MODEL_HAS_NO_DEVICES  = "The model has no devices. Please select a device to register with this Model"
STR_MODEL_FAILED_TO_CREATE= "Failed to create the model"
STR_MODEL_REGISTER_DEVICE = "Please select a device to move to the selected model"
STR_MODEL_REGISTER_FAILED = "Registering the device with the model failed"
